...
INIT
    BANKSEL OSCCON1
    MOVLW B'00000101' ; 1MHZ CLOCK
    MOVWF OSCCON1
    
    BANKSEL T2CON
    MOVLW B'00000111' ; ENABLE TIMER AND PRESCALE = 64 AND POSTSCALE = 0
    MOVWF T2CON
    ...
    BANKSEL PWM5DCH
    CLRF PWM5DCH
    BSF PWM5DCH, 2 ; SET 0.5 DC == 16
    
    BANKSEL PWM5DCL
    CLRF PWM5DCL
    
    BANKSEL PWMTMRS
    MOVLW B'00000001' ; HOOK TMR2 TO PWM5
    MOVWF PWMTMRS
    
    BANKSEL RB6PPS
    MOVLW B'00000010' ; HOOK PWM5 TO RB6
    MOVWF RB6PPS
